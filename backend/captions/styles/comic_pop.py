...
class ComicPopStyle(CaptionStyle):
    id = "comic_pop"
    display_name = "Comic Pop (thick-outline color pop with alternating tilt)"
    needs_anchor = False
    ...
    def render(self, events: list[CaptionEvent], canvas: Canvas, params: StyleParams):
        ...
        styles = [
            f"Style: Default,{params.font},{font},&H00FFFFFF,&H000000FF,&H00000000,&H00000000,1,0,0,0,100,100,0,0,1,{outline},0,2,{margin_lr},{margin_lr},{margin_v},1",
        ]
